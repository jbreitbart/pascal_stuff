...
begin
 ...
 buttonschrift(62,82,110,95,'FÅllen');
 buttonschrift(620,110,639,130,'1X');
 buttonschrift(620,140,639,160,'2X');
 button(2,42,208,70);
 ...
 repeat
  repeat
   if (mouseinwindow(x,y,x+3,y+2)) and (mousebutton=mousebuttonleft) then begin
    ...
    mousehide;
    if breite=1 then begin
     bar(x+1,y+1,x+3,y+2);
     putpixel(220+z1-1,0+z2-1,akfarbe);
     bild[z1,z2]:=akfarbe;
    end;
    if breite=2 then begin
     bar(x+1,y+1,x+3,y+2);
     putpixel(220+z1-1,0+z2-1,akfarbe);
     bild[z1,z2]:=akfarbe;
     if z1>1 then begin
      bar(x-3,y+1,x-1,y+2);
      putpixel(220+z1-1-1,0+z2-1,akfarbe);
      bild[z1-1,z2]:=akfarbe;
     end;
     if (z1>1) and (z2>1) then begin
      bar(x-3,y-2,x-1,y-1);
      putpixel(220+z1-1-1,0+z2-1-1,akfarbe);
      bild[z1-1,z2-1]:=akfarbe;
     end;
     if (z1>1) and (z2<100) then begin
      bar(x-3,y+4,x-1,y+5);
      putpixel(220+z1-1-1,0+z2-1+1,akfarbe);
      bild[z1-1,z2+1]:=akfarbe;
     end;
     if (z1<150) then begin
      bar(x+5,y+1,x+7,y+2);
      putpixel(220+z1-1+1,0+z2-1,akfarbe);
      bild[z1+1,z2]:=akfarbe;
     end;
     if (z1<150) and (z2>1) then begin
      bar(x+5,y-2,x+7,y-1);
      putpixel(220+z1-1+1,0+z2-1-1,akfarbe);
      bild[z1+1,z2-1]:=akfarbe;
     end;
     if (z1<150) and (z2<100) then begin
      bar(x+5,y+4,x+7,y+5);
      putpixel(220+z1-1+1,0+z2-1+1,akfarbe);
      bild[z1+1,z2+1]:=akfarbe;
     end;
     if z2>1 then begin
      bar(x+1,y-2,x+3,y-1);
      putpixel(220+z1-1,0+z2-1-1,akfarbe);
      bild[z1,z2-1]:=akfarbe;
     end;
     if z2<100 then begin
      bar(x+1,y+4,x+3,y+5);
      putpixel(220+z1-1,0+z2-1+1,akfarbe);
      bild[z1,z2+1]:=akfarbe;
     end;
...
begin
 ...
 da:=FileExists('c:\pascal\data\'+dateiname+'.mif');
 if da then begin
  setfillstyle(1,black);
  bar(3,43,207,69);
  setcolor(white);
  ...
  if taste ='J' then begin
   assign(f,'C:\pascal\data\'+dateiname+'.mif');
   rewrite(f,1);
...
begin
 ...
 da:=fileexists('C:\Pascal\data\'+datei+'.mif');
 ...
 if da then begin
  ...
  assign(f,'C:\pascal\data\'+Datei+'.mif');
  reset(f,1);
  lv1:=1;
  lv2:=1;
  x:=10;
...
begin
 ...
 repeat
  ...
  if breite=2 then begin
   ...
   if z2>1 then begin
    bild[z1,z2-1]:=akfarbe;
    bar(x1+1,y-2,x1+3,y-1);
    putpixel(220+z1-1,0+z2-1-1,akfarbe);
   end;
   if z2<100 then begin
    bild[z1,z2+1]:=akfarbe;
    bar(x1+1,y+4,x1+3,y+5);
    putpixel(220+z1-1,0+z2-1+1,akfarbe);
   end;
  end;
  x1:=x1+4;
...
begin
 ...
 repeat
  ...
  if (mouseinwindow(62,82,110,95)) and (mousebutton=mousebuttonleft) then fullen;
  if (mouseinwindow(620,110,639,130)) and (mousebutton=mousebuttonleft) then breite:=1;
  if (mouseinwindow(620,140,639,160)) and (mousebutton=mousebuttonleft) then breite:=2;
