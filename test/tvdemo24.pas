...
Program TVDemo24;                                {Datei: TVDemo24.pas}
...
const {ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄGlobale KonstantenÄÄ}
  ...
  cmNewWin     = 1008;                                 {Neues Fenster}
  cmDosShell   = 1009;                    {Auf die Dos-Ebene wechseln}

  ListName: PathStr = '';                        {Name der List-Datei}
  WinNr: integer = 0;                                  {Fensternummer}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
 ...
 ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ}
procedure TBspApp.NewWindow;
var
  W: PWindow;                                         {Fenster-Objekt}
  R: TRect;                         {rechteckiger Bereich fr Fenster}

begin
  Inc(WinNr);                                  {Fensternummer erh”hen}
  R.Assign(0,0,30,10);
  R.Move(Random(45),Random(13));
  W:= New(PWindow,Init(R,'Neues Fenster',WinNr));
  if ValidView(W) <> nil
   then DeskTop^.Insert(W)
   else Dec(WinNr);
end; {TBspApp.NewWindow}
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
 ³ TBspApp.DosShell                                                 ³
 ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
