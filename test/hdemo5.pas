...
begin
  ...
  MenuBar:= New(PMenuBar,Init(R,NewMenu(
    NewSubMenu('~S~ystem',hcNoContext,NewMenu(
      ...
      NewItem('Dialog~f~enster...','',kbNoKey,cmDialog,hcNoContext,
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
 ³ TDemo.DialogFenster                                        ³
 ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
 ³ Demonstriert die Hilfestellung zu einem Dialogfenster.     ³
 ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ}
procedure TDemo.Dialogfenster;
var
...
begin
  R.Assign(0,0,42,11);
  D:= New(PDialog,Init(R,'Dialogfenster'));
  D^.HelpCtx:= hcDialogFenster;                   {Hilfekontext}
  with D^ do
  begin
    Options:= Options or ofCentered;                {Zentrieren}
    R.Grow(-1,-1);                         {Fenster verkleinern}
    Insert(New(PStaticText,Init(R,
      #13 +
      ^C'Bitte rufen Sie die'#13 +
      #13 +
      ^C'Hilfestellung (F1) auf!'
    )));
    R.Assign(16,8,26,10);
