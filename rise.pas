...
begin
 ...
 mouseshow;
 repeat
  If mouseinwindow(100,100,200,150) then Waffenonline;
  If mouseinwindow(100,200,200,250) then Wirtschaftonline;
  If mouseinwindow(100,300,200,350) then Fahrzeugonline;
  If mouseinwindow(100,400,200,450) then Gebaudeonline;
